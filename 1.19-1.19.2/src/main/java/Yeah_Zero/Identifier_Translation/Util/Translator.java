...
public class Translator {
    public static final SuggestionProvider<ServerCommandSource> 结构建议提供者 = Translator.建议提供("structure", Registry.STRUCTURE_KEY, CommandSource.SuggestedIdType.ALL);
    public static final SuggestionProvider<ServerCommandSource> 生物群系建议提供者 = Translator.建议提供("biome", Registry.BIOME_KEY, CommandSource.SuggestedIdType.ALL);
    public static final SuggestionProvider<ServerCommandSource> 兴趣点建议提供者 = Translator.建议提供("poi", Registry.POINT_OF_INTEREST_TYPE_KEY, CommandSource.SuggestedIdType.ALL);
    public static final SuggestionProvider<ServerCommandSource> 具体结构建议提供者 = Translator.建议提供("specific_structure", Registry.STRUCTURE_KEY, CommandSource.SuggestedIdType.ELEMENTS);
    public static final SuggestionProvider<ServerCommandSource> 已配置地物建议提供者 = Translator.建议提供("configured_feature", Registry.CONFIGURED_FEATURE_KEY, CommandSource.SuggestedIdType.ELEMENTS);
    ...
    public static Text 翻译(String 类型, String 标签字符串, String 标识符字符串) {
        String 标签描述键名 = Util.createTranslationKey("tag", new Identifier(标签字符串.substring(1)));
        String 标识符翻译键名 = Util.createTranslationKey(类型, new Identifier(标识符字符串));
        if (类型.equals("poi")) {
            标识符翻译键名 = Text.translatable(标识符翻译键名).getString();
        }
